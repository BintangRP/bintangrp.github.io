const Experience = () => {
    const experiences = [
		...
		{
			title: "RHCSA Study Independent - Infinite Learning",
	...
	return (
		<section id="experienceSection" className="py-20 px-6 bg-gray-900">
			<div className="max-w-4xl mx-auto">
				<h2 className="text-3xl font-semibold mb-6 text-center">Journey Highlights</h2>
				<ul className="space-y-8">
					{experiences.map((experience, index) => (
						<li key={index} className="border-l-4 border-blue-500 pl-4">
							<h3 className="text-xl font-bold">{experience.title}</h3>
							<p className="text-gray-400 text-sm mb-2">{experience.time}</p>
